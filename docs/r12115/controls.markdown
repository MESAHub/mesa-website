...
{% highlight fortran %}
RSP_initial_model_outer_log_tau = -1d99
RSP_initial_model_inner_log_tau = -1d99
{% endhighlight %}
...
RSP_Fr_eqn_always_use_d_Prad_dm = .true.
{% endhighlight %}
...
RSP_limit_abs_max_dlnr = 1d-4
RSP_no_remesh_inner_fraction_zones = 0.3330d0
RSP_no_remesh_outer_fraction_zones = 0.020d0
...
<h3 id="check_elm_helm_agreement">check_elm_helm_agreement <a href="#check_elm_helm_agreement" title="Permalink to this location">¶</a></h3>
...
You can check the level of agreement between ELM and HELM.
This will warn if the differences in lnE, lnPgas, or lnS exceed 1%.

{% highlight fortran %}
use_eosELM = .true.
logT_max_for_ELM = 10d0
logQ_min_for_ELM = -12.5d0
check_elm_abar_zbar = .true.
check_elm_helm_agreement = .false.
{% endhighlight %}
...
this replaces the default dL/dm and eps_grav form.
NOTE: THIS CONTROL IS NON-FUNCTIONAL
...
Small timesteps as the center neon is exhausted.
...
Small timesteps as the center silicon is exhausted.

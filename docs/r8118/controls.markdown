...
<h3 id="uniform_accretion_rotation_factor">uniform_accretion_rotation_factor <a href="#uniform_accretion_rotation_factor" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
uniform_accretion_rotation_factor = 0d0
{% endhighlight %}
...
used when use_compression_outer_BC or use_momentum_outer_BC
T_surf is set to Tsurf_factor*T_black_body(L_surf,R_surf)
...
some temperature, set by `hot_wind_full_on_T` and `hot_wind_full_off_T`.
Similarly, the cool wind scheme has temperature controls that
set the temperature *below* which they are relevant
(`cool_wind_full_off_T` and `cool_wind_full_on_T`). The two temperature
regimes can overlap; in this case the hot and cool Mdot values are added.
The wind Mdot will ramp from 0 to full value between full\_on\_T and
full\_off\_T.
...
<h3 id="cool_wind_full_off_T">cool_wind_full_off_T <a href="#cool_wind_full_off_T" title="Permalink to this location">¶</a></h3>
...
<h3 id="hot_wind_full_off_T">hot_wind_full_off_T <a href="#hot_wind_full_off_T" title="Permalink to this location">¶</a></h3>


on for T\_phot > `hot_wind_full_on_T`
off for T\_phot < `hot_wind_full_off_T`
ramp from 0 to 1 between the two limits
set `hot_wind_full_on_T = 0` to ignore the hot_wind
...
<h3 id="diffusion_do_thermal_diffusion">diffusion_do_thermal_diffusion <a href="#diffusion_do_thermal_diffusion" title="Permalink to this location">¶</a></h3>


if true, include the heat flow vector terms in the Burgers equations
when diffusion_use_cgs_solver = .true.
these are problematic when distribution function become non-Maxwellian.

{% highlight fortran %}
diffusion_do_thermal_diffusion = .false.
{% endhighlight %}
...
for use in certain special test cases
...
values > 0 are used for gamma law eos along with simple hydro
...
<h3 id="use_lagrangian_riemann_solver">use_lagrangian_riemann_solver <a href="#use_lagrangian_riemann_solver" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
use_lagrangian_riemann_solver = .false.
{% endhighlight %}


<h3 id="use_adjust_mesh_split_merge">use_adjust_mesh_split_merge <a href="#use_adjust_mesh_split_merge" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
use_adjust_mesh_split_merge = .false.
{% endhighlight %}
...
{% highlight fortran %}
adjust_mesh_split_merge_max_iters = 100
{% endhighlight %}


<h3 id="use_3rd_order_TVD_RK">use_3rd_order_TVD_RK <a href="#use_3rd_order_TVD_RK" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
use_3rd_order_TVD_RK = .false.
{% endhighlight %}


<h3 id="use_2nd_order_TVD_RK">use_2nd_order_TVD_RK <a href="#use_2nd_order_TVD_RK" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
use_2nd_order_TVD_RK = .false.
{% endhighlight %}


<h3 id="explicit_hydro_use_luminosities">explicit_hydro_use_luminosities <a href="#explicit_hydro_use_luminosities" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_use_luminosities = .false.
{% endhighlight %}


<h3 id="explicit_hydro_timestep">explicit_hydro_timestep <a href="#explicit_hydro_timestep" title="Permalink to this location">¶</a></h3>
...
<h3 id="explicit_hydro_nz0">explicit_hydro_nz0 <a href="#explicit_hydro_nz0" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_nz0 = 1024
{% endhighlight %}


<h3 id="explicit_hydro_LogZoning">explicit_hydro_LogZoning <a href="#explicit_hydro_LogZoning" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_LogZoning = .false.
{% endhighlight %}


<h3 id="explicit_hydro_MaxLong">explicit_hydro_MaxLong <a href="#explicit_hydro_MaxLong" title="Permalink to this location">¶</a></h3>


split cell if ratio of actual/desired dr is > this; ignore if <= 0

{% highlight fortran %}
explicit_hydro_MaxLong = 2d0
{% endhighlight %}


<h3 id="explicit_hydro_MaxShort">explicit_hydro_MaxShort <a href="#explicit_hydro_MaxShort" title="Permalink to this location">¶</a></h3>


merge cell if ratio of desired/actual dr is > this; ignore if <= 0

{% highlight fortran %}
explicit_hydro_MaxShort = 4d0
{% endhighlight %}


<h3 id="explicit_hydro_trace_amr">explicit_hydro_trace_amr <a href="#explicit_hydro_trace_amr" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_trace_amr = .false.
{% endhighlight %}


<h3 id="explicit_hydro_CFL">explicit_hydro_CFL <a href="#explicit_hydro_CFL" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_CFL = 0.9d0
{% endhighlight %}


<h3 id="explicit_hydro_Energy_floor">explicit_hydro_Energy_floor <a href="#explicit_hydro_Energy_floor" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_Energy_floor = 1d-99
{% endhighlight %}


<h3 id="explicit_hydro_kap_floor_min">explicit_hydro_kap_floor_min <a href="#explicit_hydro_kap_floor_min" title="Permalink to this location">¶</a></h3>


see SNEC paper, section 2.2

{% highlight fortran %}
explicit_hydro_kap_floor_min = 1d-2
{% endhighlight %}


<h3 id="explicit_hydro_kap_floor_A">explicit_hydro_kap_floor_A <a href="#explicit_hydro_kap_floor_A" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_kap_floor_A = 0.005306d0
{% endhighlight %}


<h3 id="explicit_hydro_kap_floor_B">explicit_hydro_kap_floor_B <a href="#explicit_hydro_kap_floor_B" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_kap_floor_B = 0.234694d0
{% endhighlight %}


<h3 id="explicit_hydro_use_flux_limiter">explicit_hydro_use_flux_limiter <a href="#explicit_hydro_use_flux_limiter" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_use_flux_limiter = .true.
{% endhighlight %}


<h3 id="explicit_hydro_include_Lconv_in_Lface">explicit_hydro_include_Lconv_in_Lface <a href="#explicit_hydro_include_Lconv_in_Lface" title="Permalink to this location">¶</a></h3>


if false, then are assuming L_conv = 0, i.e., fully radiative model.

{% highlight fortran %}
explicit_hydro_include_Lconv_in_Lface = .false.
{% endhighlight %}


<h3 id="explicit_hydro_trace_interval">explicit_hydro_trace_interval <a href="#explicit_hydro_trace_interval" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_trace_interval = -1
{% endhighlight %}


<h3 id="explicit_hydro_P_atol">explicit_hydro_P_atol <a href="#explicit_hydro_P_atol" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_P_atol = 1d-3
{% endhighlight %}


<h3 id="explicit_hydro_P_rtol">explicit_hydro_P_rtol <a href="#explicit_hydro_P_rtol" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_P_rtol = 1d-3
{% endhighlight %}


<h3 id="explicit_hydro_v_atol">explicit_hydro_v_atol <a href="#explicit_hydro_v_atol" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_v_atol = 1d-3
{% endhighlight %}


<h3 id="explicit_hydro_v_rtol">explicit_hydro_v_rtol <a href="#explicit_hydro_v_rtol" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
explicit_hydro_v_rtol = 1d-3
{% endhighlight %}
...
<h3 id="do_newton_damping_for_neg_alpha_RTI">do_newton_damping_for_neg_alpha_RTI <a href="#do_newton_damping_for_neg_alpha_RTI" title="Permalink to this location">¶</a></h3>


If true, uniformly reduce newton corrections if necessary to avoid neg alpha_RTI (only used when RTI_flag true).

{% highlight fortran %}
do_newton_damping_for_neg_alpha_RTI = .true.
{% endhighlight %}
...
hydro_mtx_max_allowed_abs_dlogE = 99
...
hydro_mtx_max_allowed_logE = 99
hydro_mtx_max_allowed_logRho = 99
hydro_mtx_max_allowed_logPgas = 99
{% endhighlight %}


<h3 id="use_PCM">use_PCM <a href="#use_PCM" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_PLM">use_PLM <a href="#use_PLM" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_LPP_HARMOD">use_LPP_HARMOD <a href="#use_LPP_HARMOD" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
use_LPP_HARMOD = .false.
{% endhighlight %}
...
<h3 id="dt_div_dt_explicit_limit">dt_div_dt_explicit_limit <a href="#dt_div_dt_explicit_limit" title="Permalink to this location">¶</a></h3>


<h3 id="dt_div_dt_explicit_hard_limit">dt_div_dt_explicit_hard_limit <a href="#dt_div_dt_explicit_hard_limit" title="Permalink to this location">¶</a></h3>
...
{% highlight fortran %}
dt_div_dt_explicit_limit = -1
dt_div_dt_explicit_hard_limit = -1
{% endhighlight %}
...
<h3 id="limit_for_avg_lgE_residual">limit_for_avg_lgE_residual <a href="#limit_for_avg_lgE_residual" title="Permalink to this location">¶</a></h3>


<h3 id="hard_limit_for_avg_lgE_residual">hard_limit_for_avg_lgE_residual <a href="#hard_limit_for_avg_lgE_residual" title="Permalink to this location">¶</a></h3>
...
<h3 id="limit_for_max_abs_lgE_residual">limit_for_max_abs_lgE_residual <a href="#limit_for_max_abs_lgE_residual" title="Permalink to this location">¶</a></h3>


<h3 id="hard_limit_for_max_abs_lgE_residual">hard_limit_for_max_abs_lgE_residual <a href="#hard_limit_for_max_abs_lgE_residual" title="Permalink to this location">¶</a></h3>
...
<h3 id="stop_for_NaNs">stop_for_NaNs <a href="#stop_for_NaNs" title="Permalink to this location">¶</a></h3>

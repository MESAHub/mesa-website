...
<h3 id="change_L_flag">change_L_flag <a href="#change_L_flag" title="Permalink to this location">¶</a></h3>


<h3 id="change_initial_L_flag">change_initial_L_flag <a href="#change_initial_L_flag" title="Permalink to this location">¶</a></h3>


<h3 id="new_L_flag">new_L_flag <a href="#new_L_flag" title="Permalink to this location">¶</a></h3>
...
<h3 id="remove_initial_center_at_inner_max_v">remove_initial_center_at_inner_max_v <a href="#remove_initial_center_at_inner_max_v" title="Permalink to this location">¶</a></h3>


<h3 id="remove_center_at_inner_max_v">remove_center_at_inner_max_v <a href="#remove_center_at_inner_max_v" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
remove_initial_center_at_inner_max_v = .false.
remove_center_at_inner_max_v = .false.
{% endhighlight %}
...
<h2 id="controls_for_special_weak_rates">controls for special weak rates <a href="#controls_for_special_weak_rates" title="Permalink to this location">¶</a></h2>
...
<h3 id="kappa_type2_logT_lower_bdy">kappa_type2_logT_lower_bdy <a href="#kappa_type2_logT_lower_bdy" title="Permalink to this location">¶</a></h3>
...
<h3 id="Filenames_for_each_bolometric_correction_BC_table_to_load">Filenames for each bolometric correction (BC) table to load <a href="#Filenames_for_each_bolometric_correction_BC_table_to_load" title="Permalink to this location">¶</a></h3>
...
Due to changing the run_stars_extra functions to hooks, we break peoples
run_stars_extra files. This flag sets a warning message and stops the MESA run
until it is set to .false., if people This way people will hopefully not be
confused as to why their run_stars_extra functions are not being called.

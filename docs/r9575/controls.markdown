...
<h3 id="eos_partials_consistency_level">eos_partials_consistency_level <a href="#eos_partials_consistency_level" title="Permalink to this location">¶</a></h3>
...
<h3 id="helmeos_max_logRho_neutral">helmeos_max_logRho_neutral <a href="#helmeos_max_logRho_neutral" title="Permalink to this location">¶</a></h3>


only use this parameter if value is > -99

{% highlight fortran %}
helmeos_max_logRho_neutral = -1d99
{% endhighlight %}


<h3 id="helmeos_logT_neutral">helmeos_logT_neutral <a href="#helmeos_logT_neutral" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
helmeos_logT_neutral = -1d99
{% endhighlight %}


<h3 id="helmeos_logT_ion">helmeos_logT_ion <a href="#helmeos_logT_ion" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
helmeos_logT_ion = -1d99
{% endhighlight %}
...
{% highlight fortran %}
shock_spread_linear = -1d0
shock_spread_quadratic = -1d0
{% endhighlight %}

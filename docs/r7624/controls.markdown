...
<h2 id="radiation_turbulence">radiation turbulence <a href="#radiation_turbulence" title="Permalink to this location">¶</a></h2>
...
<h3 id="redo_mlt_for_OPEC">redo_mlt_for_OPEC <a href="#redo_mlt_for_OPEC" title="Permalink to this location">¶</a></h3>


OPacity Extended Convection -- work in progess.

{% highlight fortran %}
redo_mlt_for_OPEC = .false.
{% endhighlight %}
...
<h3 id="op_split_gradT_fraction_grada">op_split_gradT_fraction_grada <a href="#op_split_gradT_fraction_grada" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_hydrodynamic_surface_BCs">use_hydrodynamic_surface_BCs <a href="#use_hydrodynamic_surface_BCs" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_momentum_eqn_outer_BC">use_momentum_eqn_outer_BC <a href="#use_momentum_eqn_outer_BC" title="Permalink to this location">¶</a></h3>


use P_surf to set pressure gradient at surface
calculate v(1) based on that pressure gradient
this replaces the usual equation extrapolating P(1) to surface for comparison to P_surf from the atm.

{% highlight fortran %}
use_momentum_eqn_outer_BC = .false.
{% endhighlight %}
...
<h3 id="RGB_wind_scheme">RGB_wind_scheme <a href="#RGB_wind_scheme" title="Permalink to this location">¶</a></h3>
...
<h3 id="AGB_wind_scheme">AGB_wind_scheme <a href="#AGB_wind_scheme" title="Permalink to this location">¶</a></h3>
...
<h3 id="Reimers_wind_eta">Reimers_wind_eta <a href="#Reimers_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="Blocker_wind_eta__0">Blocker_wind_eta = 0 <a href="#Blocker_wind_eta__0" title="Permalink to this location">¶</a></h3>
...
<h3 id="de_Jager_wind_eta">de_Jager_wind_eta <a href="#de_Jager_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="van_Loon_wind_eta">van_Loon_wind_eta <a href="#van_Loon_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="Kudritzki_wind_eta">Kudritzki_wind_eta <a href="#Kudritzki_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="Nieuwenhuijzen_wind_eta">Nieuwenhuijzen_wind_eta <a href="#Nieuwenhuijzen_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="Vink_wind_eta">Vink_wind_eta <a href="#Vink_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="Grafener_wind_eta">Grafener_wind_eta <a href="#Grafener_wind_eta" title="Permalink to this location">¶</a></h3>
...
{% highlight fortran %}
Grafener_wind_eta = 0d0
{% endhighlight %}


<h3 id="Dutch_wind_eta">Dutch_wind_eta <a href="#Dutch_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="super_eddington_wind_eta">super_eddington_wind_eta <a href="#super_eddington_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="max_star_mass_for_loss">max_star_mass_for_loss <a href="#max_star_mass_for_loss" title="Permalink to this location">¶</a></h3>
...
<h3 id="wind_envelope_limit">wind_envelope_limit <a href="#wind_envelope_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="rlo_wind_eta">rlo_wind_eta <a href="#rlo_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="nova_wind_eta">nova_wind_eta <a href="#nova_wind_eta" title="Permalink to this location">¶</a></h3>
...
<h3 id="remesh_max_brunt_N2_composition_term">remesh_max_brunt_N2_composition_term <a href="#remesh_max_brunt_N2_composition_term" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_eosDE_get">use_eosDE_get <a href="#use_eosDE_get" title="Permalink to this location">¶</a></h3>


if `use_eosDE_get`, then call eosDE_get in mesa/eos lib.
...
<h3 id="use_brunt_dlnRho_form">use_brunt_dlnRho_form <a href="#use_brunt_dlnRho_form" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_dlnddt_form_of_density_eqn">use_dlnddt_form_of_density_eqn <a href="#use_dlnddt_form_of_density_eqn" title="Permalink to this location">¶</a></h3>


if true, use continuity equation, d(1/rho)/dt = 4*pi*d(v*r^2)/dm
else use default rho = cell_mass/cell_volume

{% highlight fortran %}
use_dlnddt_form_of_density_eqn = .false.
{% endhighlight %}
...
<h3 id="use_dEdRho_form_for_eps_grav">use_dEdRho_form_for_eps_grav <a href="#use_dEdRho_form_for_eps_grav" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_dlnd_dt_form_for_eps_grav">use_dlnd_dt_form_for_eps_grav <a href="#use_dlnd_dt_form_for_eps_grav" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_PdVdt_form_for_eps_grav">use_PdVdt_form_for_eps_grav <a href="#use_PdVdt_form_for_eps_grav" title="Permalink to this location">¶</a></h3>
...
<h3 id="include_dmu_dt_in_eps_grav">include_dmu_dt_in_eps_grav <a href="#include_dmu_dt_in_eps_grav" title="Permalink to this location">¶</a></h3>
...
<h3 id="min_dxm_Eulerian_div_dxm_CpTMdot_lt_L">min_dxm_Eulerian_div_dxm_CpTMdot_lt_L <a href="#min_dxm_Eulerian_div_dxm_CpTMdot_lt_L" title="Permalink to this location">¶</a></h3>
...
set to large value to keep injecting indefinitely

{% highlight fortran %}
duration_for_inject_extra_ergs_sec = 1d99
{% endhighlight %}
...
<h3 id="use_energy_conservation_form">use_energy_conservation_form <a href="#use_energy_conservation_form" title="Permalink to this location">¶</a></h3>


if true, then use time centered velocity and intrinsically energy conserverving forms for momentum and energy equations.

{% highlight fortran %}
use_energy_conservation_form = .false.
{% endhighlight %}


<h3 id="max_ebdf_order">max_ebdf_order <a href="#max_ebdf_order" title="Permalink to this location">¶</a></h3>


<h3 id="min_ebdf_order">min_ebdf_order <a href="#min_ebdf_order" title="Permalink to this location">¶</a></h3>


<h3 id="steps_before_try_higher_ebdf_order">steps_before_try_higher_ebdf_order <a href="#steps_before_try_higher_ebdf_order" title="Permalink to this location">¶</a></h3>


<h3 id="factor_for_ebdf_order_tests">factor_for_ebdf_order_tests <a href="#factor_for_ebdf_order_tests" title="Permalink to this location">¶</a></h3>


<h3 id="use_bdf_instead_of_ebdf">use_bdf_instead_of_ebdf <a href="#use_bdf_instead_of_ebdf" title="Permalink to this location">¶</a></h3>


<h3 id="use_sdirk_instead_of_ebdf">use_sdirk_instead_of_ebdf <a href="#use_sdirk_instead_of_ebdf" title="Permalink to this location">¶</a></h3>


<h3 id="use_symplectic_instead_of_ebdf">use_symplectic_instead_of_ebdf <a href="#use_symplectic_instead_of_ebdf" title="Permalink to this location">¶</a></h3>
...
max_ebdf_order = -1
min_ebdf_order = -1
steps_before_try_higher_ebdf_order = -1
factor_for_ebdf_order_tests = 5
{% endhighlight %}


{% highlight fortran %}
use_bdf_instead_of_ebdf = .false.
use_sdirk_instead_of_ebdf = .false.
use_symplectic_instead_of_ebdf = .false.
{% endhighlight %}


<h3 id="ebdf_redo_mix_for_final_stage">ebdf_redo_mix_for_final_stage <a href="#ebdf_redo_mix_for_final_stage" title="Permalink to this location">¶</a></h3>


EXPERIMENTAL -- not ready for use.

{% highlight fortran %}
ebdf_redo_mix_for_final_stage = .false.
{% endhighlight %}


<h3 id="ebdf_redo_mix_for_comparison_stage">ebdf_redo_mix_for_comparison_stage <a href="#ebdf_redo_mix_for_comparison_stage" title="Permalink to this location">¶</a></h3>


EXPERIMENTAL -- not ready for use.

{% highlight fortran %}
ebdf_redo_mix_for_comparison_stage = .false.
{% endhighlight %}


<h3 id="ebdf_redo_mix_coeffs_other_stages">ebdf_redo_mix_coeffs_other_stages <a href="#ebdf_redo_mix_coeffs_other_stages" title="Permalink to this location">¶</a></h3>


EXPERIMENTAL -- not ready for use.

{% highlight fortran %}
ebdf_redo_mix_coeffs_other_stages = .false.
{% endhighlight %}


<h3 id="trace_truncation_ratio">trace_truncation_ratio <a href="#trace_truncation_ratio" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
trace_truncation_ratio = .false.
{% endhighlight %}
...
<h3 id="center_flash_total_time">center_flash_total_time <a href="#center_flash_total_time" title="Permalink to this location">¶</a></h3>


<h3 id="center_flash_ramp_up_time">center_flash_ramp_up_time <a href="#center_flash_ramp_up_time" title="Permalink to this location">¶</a></h3>


<h3 id="center_flash_ramp_down_time">center_flash_ramp_down_time <a href="#center_flash_ramp_down_time" title="Permalink to this location">¶</a></h3>


<h3 id="center_flash_total_ergs">center_flash_total_ergs <a href="#center_flash_total_ergs" title="Permalink to this location">¶</a></h3>


inject energy by temporarily increasing L_center at start of run
center_flash_total_time includes ramp_up and ramp_down times (sec)
center_flash_ramp_up_duration = duration of initial linear increase (sec)
center_flash_ramp_down_duration = duration of final linear decrease (sec)

{% highlight fortran %}
center_flash_total_time = -1d99
center_flash_ramp_up_duration = -1d99
center_flash_ramp_down_duration = -1d99
center_flash_total_ergs = 0d0
{% endhighlight %}


<h3 id="use_piston">use_piston <a href="#use_piston" title="Permalink to this location">¶</a></h3>


+ if `use_piston` is true, then change `R_center` and `v_center` to mimic a piston
+ if `use_piston .and. piston_period > 0`, then use a periodic piston
+ if `use_piston .and. piston_period <= 0`, then use a "kepler" style piston
...
<h3 id="piston_period">piston_period <a href="#piston_period" title="Permalink to this location">¶</a></h3>
...
<h3 id="periodic_piston_max_displacement">periodic_piston_max_displacement <a href="#periodic_piston_max_displacement" title="Permalink to this location">¶</a></h3>


`piston displacement = max_displacement*sin(2*pi*time/period)` [cm]

{% highlight fortran %}
periodic_piston_max_displacement = 0
{% endhighlight %}


<h3 id="periodic_piston_number_of_cycles">periodic_piston_number_of_cycles <a href="#periodic_piston_number_of_cycles" title="Permalink to this location">¶</a></h3>


`periodic_piston_number_of_cycles` determines stopping time for piston.
piston stops at `time = 2*pi*period*number_of_cycles`

{% highlight fortran %}
periodic_piston_number_of_cycles = 0
{% endhighlight %}


<h3 id="periodic_piston_done_delay">periodic_piston_done_delay <a href="#periodic_piston_done_delay" title="Permalink to this location">¶</a></h3>
...
{% highlight fortran %}
periodic_piston_done_delay = 0
{% endhighlight %}


<h3 id="piston_inward_time">piston_inward_time <a href="#piston_inward_time" title="Permalink to this location">¶</a></h3>


non-periodic piston moves inward for this amount of time starting at t=0

{% highlight fortran %}
piston_inward_time = 0.45
{% endhighlight %}


<h3 id="piston_Rmin">piston_Rmin <a href="#piston_Rmin" title="Permalink to this location">¶</a></h3>


non-periodic piston moves inward until it reaches this radius
...
<h3 id="piston_Rmax">piston_Rmax <a href="#piston_Rmax" title="Permalink to this location">¶</a></h3>


non-periodic piston moves outward until it reaches this radius
...
<h3 id="piston_v0">piston_v0 <a href="#piston_v0" title="Permalink to this location">¶</a></h3>


cm/s; pick to give desired ejecta kinetic energy at infinity
non-periodic piston moves outward starting at this velocity.
the velocity decreases so that the piston coasts to a stop at piston_Rmax.
...
<h3 id="reset_total_energy_initial_when_done_with_piston">reset_total_energy_initial_when_done_with_piston <a href="#reset_total_energy_initial_when_done_with_piston" title="Permalink to this location">¶</a></h3>


for use when keeping track of energy balance.

{% highlight fortran %}
reset_total_energy_initial_when_done_with_piston = .true.
{% endhighlight %}
...
<h3 id="just_use_energy_resid">just_use_energy_resid <a href="#just_use_energy_resid" title="Permalink to this location">¶</a></h3>


for calculation of residual norm and max.

{% highlight fortran %}
just_use_energy_resid = .false.
{% endhighlight %}
...
<h3 id="sizeB_gam0">sizeB_gam0 <a href="#sizeB_gam0" title="Permalink to this location">¶</a></h3>


<h3 id="size_del_gam">size_del_gam <a href="#size_del_gam" title="Permalink to this location">¶</a></h3>
...
<h3 id="refine_solution">refine_solution <a href="#refine_solution" title="Permalink to this location">¶</a></h3>
...
<h3 id="refine_mtx_solution">refine_mtx_solution <a href="#refine_mtx_solution" title="Permalink to this location">¶</a></h3>
...
{% highlight fortran %}
newton_reduced_min_corr_coeff = 0.1
{% endhighlight %}
...
<h3 id="split_mix_do_burn">split_mix_do_burn <a href="#split_mix_do_burn" title="Permalink to this location">¶</a></h3>
...
<h3 id="op_split_burn_mix_num_passes">op_split_burn_mix_num_passes <a href="#op_split_burn_mix_num_passes" title="Permalink to this location">¶</a></h3>
...
<h3 id="burn_max_iters_limit">burn_max_iters_limit <a href="#burn_max_iters_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="burn_max_iters_hard_limit">burn_max_iters_hard_limit <a href="#burn_max_iters_hard_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="burn_max_substeps_limit">burn_max_substeps_limit <a href="#burn_max_substeps_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="burn_max_substeps_hard_limit">burn_max_substeps_hard_limit <a href="#burn_max_substeps_hard_limit" title="Permalink to this location">¶</a></h3>
...
Here's a dictionary mapping those terminal strings to the corresponding control parameters.
         ...
         'avg E resid'          limit_for_avg_E_residual
         ...
         'burn iters'           burn_max_iters_limit
         'burn steps'           burn_max_substeps_limit
         'dH'                   dH_limit
         'dH/H'                 dH_div_H_limit
         'dHe'                  dHe_limit
         ...
         'dt_Courant'           dt_div_dt_Courant_limit
...
<h3 id="truncation_ratio_xh_atol">truncation_ratio_xh_atol <a href="#truncation_ratio_xh_atol" title="Permalink to this location">¶</a></h3>


<h3 id="truncation_ratio_xh_rtol">truncation_ratio_xh_rtol <a href="#truncation_ratio_xh_rtol" title="Permalink to this location">¶</a></h3>


<h3 id="truncation_ratio_xa_atol">truncation_ratio_xa_atol <a href="#truncation_ratio_xa_atol" title="Permalink to this location">¶</a></h3>


<h3 id="truncation_ratio_xa_rtol">truncation_ratio_xa_rtol <a href="#truncation_ratio_xa_rtol" title="Permalink to this location">¶</a></h3>


<h3 id="eval_truncation_ratio_do_max">eval_truncation_ratio_do_max <a href="#eval_truncation_ratio_do_max" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
truncation_ratio_xh_atol = 1d-4
truncation_ratio_xh_rtol = 1d-4
truncation_ratio_xa_atol = 1d-4
truncation_ratio_xa_rtol = 1d-4
eval_truncation_ratio_do_max = .true.
{% endhighlight %}


<h3 id="use_truncation_ratio_limit">use_truncation_ratio_limit <a href="#use_truncation_ratio_limit" title="Permalink to this location">¶</a></h3>


if false, then skip test of truncation ratio and use varcontrol instead.

{% highlight fortran %}
use_truncation_ratio_limit = .true.
{% endhighlight %}


<h3 id="truncation_ratio_limit">truncation_ratio_limit <a href="#truncation_ratio_limit" title="Permalink to this location">¶</a></h3>


If estimated local truncation error > this, reduce the next timestep.

{% highlight fortran %}
truncation_ratio_limit = 1d99
{% endhighlight %}


<h3 id="truncation_ratio_hard_limit">truncation_ratio_hard_limit <a href="#truncation_ratio_hard_limit" title="Permalink to this location">¶</a></h3>


If estimated local truncation error > this, retry.

{% highlight fortran %}
truncation_ratio_hard_limit = 1d99
{% endhighlight %}
...
<h3 id="dt_div_dt_Courant_limit">dt_div_dt_Courant_limit <a href="#dt_div_dt_Courant_limit" title="Permalink to this location">¶</a></h3>


<h3 id="dt_div_dt_Courant_hard_limit">dt_div_dt_Courant_hard_limit <a href="#dt_div_dt_Courant_hard_limit" title="Permalink to this location">¶</a></h3>


limit for dt compared to Courant timescale (negative means no limit)

dt_Courant = min over shells of sound crossing time, dr/csound

{% highlight fortran %}
dt_div_dt_Courant_limit = -1
dt_div_dt_Courant_hard_limit = -1
{% endhighlight %}
...
<h3 id="limit_for_avg_E_residual">limit_for_avg_E_residual <a href="#limit_for_avg_E_residual" title="Permalink to this location">¶</a></h3>


<h3 id="hard_limit_for_avg_E_residual">hard_limit_for_avg_E_residual <a href="#hard_limit_for_avg_E_residual" title="Permalink to this location">¶</a></h3>


avg_E_residual = abs(dot_product(s% dq(1:s% nz),s% E_residual(1:s% nz)))

{% highlight fortran %}
limit_for_avg_E_residual = 1d99
hard_limit_for_avg_E_residual = 1d99
{% endhighlight %}
...
<h1 id="debugging_output_controls">debugging output controls <a href="#debugging_output_controls" title="Permalink to this location">¶</a></h1>
...
{% highlight fortran %}
use_other_edit_pulsation_info = .false.
use_other_edit_gyre_info = .false.
use_other_get_gyre_model = .false.
{% endhighlight %}

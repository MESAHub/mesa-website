...
<h3 id="D_omega_mixing_in_convection_regions_previously_called_D_omega_mixing_in_convection_regions">D_omega_mixing_in_convection_regions (previously called D_omega_mixing_in_convection_regions) <a href="#D_omega_mixing_in_convection_regions_previously_called_D_omega_mixing_in_convection_regions" title="Permalink to this location">¶</a></h3>
...
<h3 id="dudt_use_bdf2">dudt_use_bdf2 <a href="#dudt_use_bdf2" title="Permalink to this location">¶</a></h3>


<h3 id="dudt_use_bdf3">dudt_use_bdf3 <a href="#dudt_use_bdf3" title="Permalink to this location">¶</a></h3>


only for cases when no remeshing and no change in dt for several preceding steps.

...
predictive_superad_thresh = 0.005d0
...
<h3 id="use_eosMHD_with_eosDT">use_eosMHD_with_eosDT <a href="#use_eosMHD_with_eosDT" title="Permalink to this location">¶</a></h3>


overwrite the control of same name in the `Eos_General_Info` structure

{% highlight fortran %}
use_eosMHD_with_eosDT = .false.
{% endhighlight %}

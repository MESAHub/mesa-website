...
<h2 id="SelfDriving_Overshoot__Semiconvection_SDOS_mixing">Self-Driving Overshoot & Semiconvection (S-DOS) mixing <a href="#SelfDriving_Overshoot__Semiconvection_SDOS_mixing" title="Permalink to this location">¶</a></h2>
...
<h3 id="fitted_i_rot_flag">fitted_i_rot_flag <a href="#fitted_i_rot_flag" title="Permalink to this location">¶</a></h3>


EXPERIMENTAL: If true and simple_i_rot_flag = .false.,
 use fit to i_rot that depends on rotation rate.
...
for, and it is at an optical depth below min_tau_for_adjust_J_lost.
Angular momentum in these regions is adjusted in such a way that
...
angular momentum than mass_lost*s% j_rot_avg_surf, for instance magnetic
...
<h3 id="use_fitted_fpft">use_fitted_fpft <a href="#use_fitted_fpft" title="Permalink to this location">¶</a></h3>


Use analytical fits to the rotational corrections fp and ft, computed using
the Roche potential for a single particle.
...
<h3 id="w_div_wcrit_min_for_fpft">w_div_wcrit_min_for_fpft <a href="#w_div_wcrit_min_for_fpft" title="Permalink to this location">¶</a></h3>


When use_fitted_fpft = .true., limit fp and ft to their values at this
w_div_wcrit
...
Used for the calculation when use_fitted_fpft = .false., otherwise the
limits are set using w_div_wcrit_min_for_fpft
...
Used for the calculation when use_fitted_fpft = .false.
...
<h3 id="use_split_merge_amr_log_zoning">use_split_merge_amr_log_zoning <a href="#use_split_merge_amr_log_zoning" title="Permalink to this location">¶</a></h3>


if true, target is even grid spacing in logr
if false, target is even grid spacing in r
...
overwrites the control of same name in the `Eos_General_Info` structure
if use_eosPTEH_for_low_density is true, 
use PTEH for logRho < -10 or so.  i.e., regions not covered by OPAL/SCVH.
...
overwrites the control of same name in the `Eos_General_Info` structure
if use_eosPTEH_for_high_Z and use_eosDT2, 
use DT2 in place of OPAL/SCVH for cases with Z < Z_for_all_PTEH
...
use ELM in high Rho and T regions where otherwise use HELM.
limit use of ELM to logT <= logT_max_for_ELM
...
<h3 id="Note_that_these_parameters_are_not_exactly_the_same">Note that these parameters are not exactly the same <a href="#Note_that_these_parameters_are_not_exactly_the_same" title="Permalink to this location">¶</a></h3>


<h3 id="as_used_by_Paul_Duffell__">as used by Paul Duffell.   <a href="#as_used_by_Paul_Duffell__" title="Permalink to this location">¶</a></h3>


<h3 id="His_calibrated_D_is_2_where_mesa_uses_D__3_see_mesaIV_paper">His calibrated D is 2, where mesa uses D = 3 (see mesaIV paper). <a href="#His_calibrated_D_is_2_where_mesa_uses_D__3_see_mesaIV_paper" title="Permalink to this location">¶</a></h3>


<h3 id="Users_should_try_both_values_since_the_choice_is_not_clear_cut">Users should try both values since the choice is not clear cut. <a href="#Users_should_try_both_values_since_the_choice_is_not_clear_cut" title="Permalink to this location">¶</a></h3>
...
<h3 id="use_time_centering">use_time_centering <a href="#use_time_centering" title="Permalink to this location">¶</a></h3>

...
<h3 id="set_PTEH_Zs">set_PTEH_Zs <a href="#set_PTEH_Zs" title="Permalink to this location">¶</a></h3>


<h3 id="Z_full_PTEH">Z_full_PTEH <a href="#Z_full_PTEH" title="Permalink to this location">¶</a></h3>


<h3 id="Z_part_PTEH">Z_part_PTEH <a href="#Z_part_PTEH" title="Permalink to this location">¶</a></h3>


If `set_PTEH_Zs` false, just use the eos default.
Use full PTEH table for Z > `Z_full_PTEH`.
Use partial PTEH table for Z < `Z_part_PTEH`.
Blend in the region `Z_part_PTEH < Z < Z_full_PTEH`.
This simply changes the corresponding values in the eos info.
...
<h3 id="use_IIp_opacities">use_IIp_opacities <a href="#use_IIp_opacities" title="Permalink to this location">¶</a></h3>


experimental. not yet part of public release.

{% highlight fortran %}
use_IIp_opacities = .false.
{% endhighlight %}


<h3 id="min_logT_for_IIp_opacities">min_logT_for_IIp_opacities <a href="#min_logT_for_IIp_opacities" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
min_logT_for_IIp_opacities = -1d99
{% endhighlight %}


<h3 id="use_Ib_opacities">use_Ib_opacities <a href="#use_Ib_opacities" title="Permalink to this location">¶</a></h3>


experimental. not yet part of public release.

{% highlight fortran %}
use_Ib_opacities = .false.
{% endhighlight %}

...
<h2 id="Rayleigh_Taylor_Instability_">Rayleigh Taylor Instability  <a href="#Rayleigh_Taylor_Instability_" title="Permalink to this location">¶</a></h2>
...
RSP remesh - not ready

note that rsp remeshing is off if okay_to_remesh is false

{% highlight fortran %}
RSP_remesh_interval = 10
RSP_max_periods_for_remeshing = -1
RSP_max_model_number_for_remeshing = -1
RSP_stop_remesh_after_set_velocities = .true.
RSP_do_global_remapping_corrections = .false.
{% endhighlight %}


RSP_mesh_function is the sum of the following terms

{% highlight fortran %}
RSP_remesh_lntau_weight = 0d0
RSP_remesh_tau_offset = 0d0
RSP_remesh_lnm_weight = 0d0
RSP_remesh_lnR_weight = 0d0
RSP_remesh_R_weight = 1d0
{% endhighlight %}


{% highlight fortran %}
RSP_report_remesh_interval = 0
{% endhighlight %}


{% highlight fortran %}
RSP_remesh_v_blend_fraction_for_KE = 1.0d0
RSP_remesh_PE_instead_of_Rho = .false.
{% endhighlight %}


{% highlight fortran %}
RSP_remesh_fraction = 1d0
RSP_remesh_fraction_first_remesh = 1d0
RSP_limit_max_revise_dq_ratio = 2d0
RSP_limit_max_revise_dq_ratio_first_remesh = 1d99
RSP_remesh_max_dq_jump = 1.5d0
RSP_remesh_max_dq_jump_first_remesh = 1d99
RSP_remesh_min_dq = 1d-10
RSP_remesh_skip_outer_num_div_nz_cells = 0.02d0
RSP_remesh_skip_inner_num_div_nz_cells = 0.10d0
{% endhighlight %}
...
<h3 id="mlt_time_lag_factor_increase">mlt_time_lag_factor_increase <a href="#mlt_time_lag_factor_increase" title="Permalink to this location">¶</a></h3>


time lag MLT increasing convection velocity in a manner similar to Guzik and Lovekin, 2014.
applies when current MLT convection velocity is greater than the previous convection velocity.
fraction of a mixing length the convective eddy can travel in one time step.
0d0 turns off time lag control
1d0 is a reasonable value for doing time lag
> 1d0 allows eddy to travel more than a mixing length in a time step.
< 1d0 restricts the eddy to going less than a mixing length in a time step.
conv_vel = tau*mlt_conv_vel_standard_static_value + (1d0 - tau)*previous_conv_vel
where tau = max(0d0, min(1d0, mlt_conv_vel_standard*dt*mlt_time_lag_factor/mixing_length))

{% highlight fortran %}
mlt_time_lag_factor_increase = 0d0
{% endhighlight %}


<h3 id="mlt_time_lag_factor_decrease">mlt_time_lag_factor_decrease <a href="#mlt_time_lag_factor_decrease" title="Permalink to this location">¶</a></h3>


time lag MLT decreasing convection velocity in a manner similar to Guzik and Lovekin, 2014.
applies when current MLT convection velocity is less than the previous convection velocity.
fraction of a mixing length the convective eddy can travel in one time step.
0d0 turns off time lag control
1d0 is a reasonable value for doing time lag
> 1d0 allows eddy to travel more than a mixing length in a time step.
...
{% highlight fortran %}
mlt_time_lag_factor_decrease = 0d0
{% endhighlight %}
...
<h3 id="atm_option">atm_option <a href="#atm_option" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_off_table_option">atm_off_table_option <a href="#atm_off_table_option" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_lnPgas_flag">atm_lnPgas_flag <a href="#atm_lnPgas_flag" title="Permalink to this location">¶</a></h3>


Set lnPgas_flag = .true. in the atmosphere, regardless of its actual
value in the &star_job namelist. Useful for comparing against older versions
of MESA. Note that if lnPgas_flag is already .true., this control does
nothing
...
<h3 id="atm_T_tau_relation">atm_T_tau_relation <a href="#atm_T_tau_relation" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_T_tau_opacity">atm_T_tau_opacity <a href="#atm_T_tau_opacity" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_T_tau_errtol">atm_T_tau_errtol <a href="#atm_T_tau_errtol" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_T_tau_max_iters">atm_T_tau_max_iters <a href="#atm_T_tau_max_iters" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_T_tau_max_steps">atm_T_tau_max_steps <a href="#atm_T_tau_max_steps" title="Permalink to this location">¶</a></h3>


Maximum number of steps for integrating the hydrostatic equilibrium
equation when `atm_option` = `'T_tau' and
...
<h3 id="atm_table">atm_table <a href="#atm_table" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_irradiated_opacity">atm_irradiated_opacity <a href="#atm_irradiated_opacity" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_irradiated_errtol">atm_irradiated_errtol <a href="#atm_irradiated_errtol" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_irradiated_max_iters">atm_irradiated_max_iters <a href="#atm_irradiated_max_iters" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_irradiated_T_eq">atm_irradiated_T_eq <a href="#atm_irradiated_T_eq" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_irradiated_kap_v_div_kap_th">atm_irradiated_kap_v_div_kap_th <a href="#atm_irradiated_kap_v_div_kap_th" title="Permalink to this location">¶</a></h3>


<h3 id="atm_irradiated_kap_v">atm_irradiated_kap_v <a href="#atm_irradiated_kap_v" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_irradiated_P_surf">atm_irradiated_P_surf <a href="#atm_irradiated_P_surf" title="Permalink to this location">¶</a></h3>
...
<h3 id="Pacyznski_atm_R_surf_errtol">Pacyznski_atm_R_surf_errtol <a href="#Pacyznski_atm_R_surf_errtol" title="Permalink to this location">¶</a></h3>
...
<h3 id="atm_build_tau_outer">atm_build_tau_outer <a href="#atm_build_tau_outer" title="Permalink to this location">¶</a></h3>


<h3 id="atm_build_dlogtau">atm_build_dlogtau <a href="#atm_build_dlogtau" title="Permalink to this location">¶</a></h3>


<h3 id="atm_build_errtol">atm_build_errtol <a href="#atm_build_errtol" title="Permalink to this location">¶</a></h3>
...
<h3 id="mesh_delta_coeff_factor_smooth_iters">mesh_delta_coeff_factor_smooth_iters <a href="#mesh_delta_coeff_factor_smooth_iters" title="Permalink to this location">¶</a></h3>
...
<h3 id="mass_eqn_cells_for_edge_avg">mass_eqn_cells_for_edge_avg <a href="#mass_eqn_cells_for_edge_avg" title="Permalink to this location">¶</a></h3>


<h3 id="mass_eqn_max_cells_for_blend">mass_eqn_max_cells_for_blend <a href="#mass_eqn_max_cells_for_blend" title="Permalink to this location">¶</a></h3>


<h3 id="mass_eqn_fraction_of_cells_for_blend">mass_eqn_fraction_of_cells_for_blend <a href="#mass_eqn_fraction_of_cells_for_blend" title="Permalink to this location">¶</a></h3>


<h3 id="mass_eqn_blend_upper">mass_eqn_blend_upper <a href="#mass_eqn_blend_upper" title="Permalink to this location">¶</a></h3>


<h3 id="mass_eqn_blend_lower">mass_eqn_blend_lower <a href="#mass_eqn_blend_lower" title="Permalink to this location">¶</a></h3>


<h3 id="mass_eqn_grid_func_T">mass_eqn_grid_func_T <a href="#mass_eqn_grid_func_T" title="Permalink to this location">¶</a></h3>


<h3 id="mass_eqn_grid_func_L">mass_eqn_grid_func_L <a href="#mass_eqn_grid_func_L" title="Permalink to this location">¶</a></h3>


options used for the moving mesh algorithm, VERY EXPERIMENTAL!

{% highlight fortran %}
mass_eqn_cells_for_edge_avg = 10
mass_eqn_max_cells_for_blend = 10
mass_eqn_fraction_of_cells_for_blend = 10
mass_eqn_blend_upper = .false.
mass_eqn_blend_lower = .true.
mass_eqn_grid_func_T = 0.1d0
mass_eqn_grid_func_L = 0.1d0
{% endhighlight %}
...
https://ui.adsabs.harvard.edu/#abs/2005MNRAS.362L...1S
...
<h3 id="use_correction_for_KE_plus_PE_with_eps_grav_in_energy_eqn">use_correction_for_KE_plus_PE_with_eps_grav_in_energy_eqn <a href="#use_correction_for_KE_plus_PE_with_eps_grav_in_energy_eqn" title="Permalink to this location">¶</a></h3>


<h3 id="previously_known_as_use_eps_correction_for_KE_plus_PE_in_dLdm_eqn">previously known as use_eps_correction_for_KE_plus_PE_in_dLdm_eqn <a href="#previously_known_as_use_eps_correction_for_KE_plus_PE_in_dLdm_eqn" title="Permalink to this location">¶</a></h3>
...
<h3 id="max_logQ_for_dedt_form_of_energy_eqn">max_logQ_for_dedt_form_of_energy_eqn <a href="#max_logQ_for_dedt_form_of_energy_eqn" title="Permalink to this location">¶</a></h3>
...
{% highlight fortran %}
max_logQ_for_dedt_form_of_energy_eqn = 1d99
{% endhighlight %}
...
If true, report when force another iteration in newton solver.
...
<h3 id="use_Fraley_time_centering">use_Fraley_time_centering <a href="#use_Fraley_time_centering" title="Permalink to this location">¶</a></h3>


for time weighting in energy and momentum equations
to give intrinsic conservation of total energy,
and to minimize numerical damping.
as discussed in the 3rd mesa instrument paper (2015).
only applicable when v_flag true.  not for u_flag.
...
<h3 id="pressure_from_convective_turbulence_estimated_from_MLT_convection_velocity">pressure from convective turbulence estimated from MLT convection velocity <a href="#pressure_from_convective_turbulence_estimated_from_MLT_convection_velocity" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
Pturb_MLT_factor = 0d0
{% endhighlight %}


pressure from convective turbulence is estimated using the MLT convection velocity
Pturb = rho*conv_vel**2/3 where conv_vel is provided by MLT.
the structure equations use P + Pturb_MLT_factor*Pturb where P is the non-turbulent pressure.

note that this is only available when use_dedt_form_of_energy_eqn without artificial viscosity
and not using lnPgas for eos argument (i.e., lnPgas_flag must be false).
...
<h3 id="use_avQ_art_visc">use_avQ_art_visc <a href="#use_avQ_art_visc" title="Permalink to this location">¶</a></h3>
...
This is counted from the model number that triggers a backup,
not from the model number after the backup occurs.
...
<h3 id="delta_XH_cntr_limit">delta_XH_cntr_limit <a href="#delta_XH_cntr_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XH_cntr_hard_limit">delta_XH_cntr_hard_limit <a href="#delta_XH_cntr_hard_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XHe_cntr_limit">delta_XHe_cntr_limit <a href="#delta_XHe_cntr_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XHe_cntr_hard_limit">delta_XHe_cntr_hard_limit <a href="#delta_XHe_cntr_hard_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XC_cntr_limit">delta_XC_cntr_limit <a href="#delta_XC_cntr_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XC_cntr_hard_limit">delta_XC_cntr_hard_limit <a href="#delta_XC_cntr_hard_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XNe_cntr_limit">delta_XNe_cntr_limit <a href="#delta_XNe_cntr_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XNe_cntr_hard_limit">delta_XNe_cntr_hard_limit <a href="#delta_XNe_cntr_hard_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XO_cntr_limit">delta_XO_cntr_limit <a href="#delta_XO_cntr_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XO_cntr_hard_limit">delta_XO_cntr_hard_limit <a href="#delta_XO_cntr_hard_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XSi_cntr_limit">delta_XSi_cntr_limit <a href="#delta_XSi_cntr_limit" title="Permalink to this location">¶</a></h3>
...
<h3 id="delta_XSi_cntr_hard_limit">delta_XSi_cntr_hard_limit <a href="#delta_XSi_cntr_hard_limit" title="Permalink to this location">¶</a></h3>

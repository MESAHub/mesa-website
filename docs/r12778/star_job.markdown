...
stella_skip_inner_dm = 0.1d0
stella_skip_inner_v_limit = 1d5
stella_mdot_years_for_wind = 1.2d0
stella_mdot_for_wind = 0.30d0
stella_v_wind = 12
...
<h3 id="load_saved_model_for_RSP">load_saved_model_for_RSP <a href="#load_saved_model_for_RSP" title="Permalink to this location">¶</a></h3>
...
<h3 id="change_Eturb_flag">change_Eturb_flag <a href="#change_Eturb_flag" title="Permalink to this location">¶</a></h3>


<h3 id="change_initial_Eturb_flag">change_initial_Eturb_flag <a href="#change_initial_Eturb_flag" title="Permalink to this location">¶</a></h3>


<h3 id="change_Eturb_flag_at_model_number">change_Eturb_flag_at_model_number <a href="#change_Eturb_flag_at_model_number" title="Permalink to this location">¶</a></h3>


<h3 id="new_Eturb_flag">new_Eturb_flag <a href="#new_Eturb_flag" title="Permalink to this location">¶</a></h3>
...
<h3 id="remove_initial_surface_by_v_surf_div_cs">remove_initial_surface_by_v_surf_div_cs <a href="#remove_initial_surface_by_v_surf_div_cs" title="Permalink to this location">¶</a></h3>


<h3 id="remove_initial_surface_by_v_surf_div_v_escape">remove_initial_surface_by_v_surf_div_v_escape <a href="#remove_initial_surface_by_v_surf_div_v_escape" title="Permalink to this location">¶</a></h3>
...
<h3 id="remove_surface_by_v_surf_div_cs">remove_surface_by_v_surf_div_cs <a href="#remove_surface_by_v_surf_div_cs" title="Permalink to this location">¶</a></h3>


<h3 id="remove_surface_by_v_surf_div_v_escape">remove_surface_by_v_surf_div_v_escape <a href="#remove_surface_by_v_surf_div_v_escape" title="Permalink to this location">¶</a></h3>
...
<h3 id="set_cumulative_energy_error">set_cumulative_energy_error <a href="#set_cumulative_energy_error" title="Permalink to this location">¶</a></h3>


<h3 id="set_cumulative_energy_error_at_step">set_cumulative_energy_error_at_step <a href="#set_cumulative_energy_error_at_step" title="Permalink to this location">¶</a></h3>
...
<h3 id="set_eosPTEH_parameters">set_eosPTEH_parameters <a href="#set_eosPTEH_parameters" title="Permalink to this location">¶</a></h3>
...
<h3 id="logRho_max_for_all_PTEH">logRho_max_for_all_PTEH <a href="#logRho_max_for_all_PTEH" title="Permalink to this location">¶</a></h3>


<h3 id="logRho_max_for_any_PTEH">logRho_max_for_any_PTEH <a href="#logRho_max_for_any_PTEH" title="Permalink to this location">¶</a></h3>


<h3 id="logQ_max_for__PTEH">logQ_max_for__PTEH <a href="#logQ_max_for__PTEH" title="Permalink to this location">¶</a></h3>


Change PTEH options/limits
If `set_eosPTEH_parameters` true, change options/limits.
...
blend with OPAL/SCVH data.

note that the PTEH tables do not extend to as high logQ as OPAL/SCVH

{% highlight fortran %}
set_eosPTEH_parameters = .false.
{% endhighlight %}
...
{% highlight fortran %}
logRho_max_for_all_PTEH = 2.97d0
logRho_max_for_any_PTEH = 3.12d0
{% endhighlight %}


{% highlight fortran %}
logQ_max_for_PTEH = -0.4d0
{% endhighlight %}
...
<h3 id="eosPTEH_use_linear_interp_for_X">eosPTEH_use_linear_interp_for_X <a href="#eosPTEH_use_linear_interp_for_X" title="Permalink to this location">¶</a></h3>


{% highlight fortran %}
eosPTEH_use_linear_interp_for_X = .false.
{% endhighlight %}
...
to use provided tables set `kappa_lowT_prefix = 'AESOPUS_AGSS09'`
this will load the file `AESOPUS_AGSS09.h5`

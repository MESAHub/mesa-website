...
do_one() {
    ...
    svn export -r $1 ${MESA_SVN} /tmp/${MESA_FILENAME}

    zip -r /tmp/${MESA_FILENAME}.zip /tmp/${MESA_FILENAME}
    rsync -e ssh /tmp/${MESA_FILENAME}.zip frs.sourceforge.net:/home/frs/project/mesa/releases

    rm /tmp/${MESA_FILENAME}.zip
    rm -rf /tmp/${MESA_FILENAME}
